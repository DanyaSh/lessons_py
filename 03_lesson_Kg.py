...
Задача не понятна, и нет объяснения, зачем делать атрибуты класса скрытыми и получать к ним доступ через @property и @*.setter
Для более полной картины было создано 3 атрибута, kg + val + name.
'''
